...
public:
	...
	//virtual void CreateToDoList() const = 0 ;//создания списка дел
	//virtual void SetExecutionDates() const = 0;//установки дат выполнения
	//virtual void SetPriority_() const = 0;
	//virtual void DeleteAffair() const = 0; //удаление
	//virtual void ChangeAffair() const = 0; //изменения дел
	//virtual void Read_from_file() const = 0; //загружать файл
	//virtual void Write_to_file() const = 0; // сохранять в файл
	//virtual void FindAffair() const = 0; //поиска конкретного дела
	//virtual void FindAffair_by_Date() const = 0; //поиска конкретного дела по дате
	//virtual void FindAffair_by_Tag() const = 0; //поиска конкретного дела по тегу (виконано не виконано)
	//virtual void FindAffair_by_Priority() const = 0; //поиска конкретного дела по приоритету
